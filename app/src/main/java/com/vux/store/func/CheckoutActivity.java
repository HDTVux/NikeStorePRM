...
import com.vux.store.model.OrderStatusResponse;
import com.vux.store.model.VnPayResponse;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private com.vux.store.adapter.CartAdapter cartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartAdapter = new com.vux.store.adapter.CartAdapter();
    ...
    private void onPayClicked() {
        ...
        if (!sm.isLoggedIn()) {
            ...
            startActivity(new Intent(this, com.vux.store.func.Login.class));
            return;
        }
